...
![test1](/AWS-FCJ-Workshop-2025/images/5-Workshop/5.4-S3-onprem/test1.png)
...
![test2](/AWS-FCJ-Workshop-2025/images/5-Workshop/5.4-S3-onprem/test2.png)

```bash
agentcore invoke "{'prompt': 'which country was i referring to'}"
```

![test3](/AWS-FCJ-Workshop-2025/images/5-Workshop/5.4-S3-onprem/test3.png)
